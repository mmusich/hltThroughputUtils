...
jobLabel="${1}"
runNumber=381065
outDir=/data/user/"${USER}"/output/hltThroughputUtils

export SITECONFIG_PATH=/data/timing/SITECONF/local
...
cp /data/timing/output/missirol/CMSSW_14_0_8_MULTIARCHS_240608_testCMSHLT3232_test01_try0.20240608_165353/hlt_customised.py "${jobLabel}"_cfg.py
