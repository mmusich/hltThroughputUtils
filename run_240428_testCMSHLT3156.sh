...
cp /gpu_data/store/data/Run2023D/EphemeralHLTPhysics/FED/pileup62/run"${runNumber}"_cff.py .

cat <<@EOF >> "${jobLabel}"_cfg.py

process.load('run${runNumber}_cff')

from customize_240428_testCMSHLT3156 import customizeHLTforThroughputMeasurement
