...
cp /fff/user/missirol/240419_testCMSHLT3156/hltThroughputUtils/Run379660_HLTPhysics/run"${runNumber}"_cff.py .

cat <<@EOF >> "${jobLabel}"_cfg.py

process.load('run${runNumber}_cff')

from customize_240423_testCMSHLT3156 import customizeHLTforThroughputMeasurement
